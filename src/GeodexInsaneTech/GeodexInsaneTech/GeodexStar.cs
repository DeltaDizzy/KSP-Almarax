...
namespace GeodexInsaneTech
{
    namespace Modules
    {
		//Based on the GeodexStar class
		
        /// <summary>
        /// Implementation of the <see cref="Sun"/> API.
        /// </summary>
        public class GeodexStar : Sun
        {
            /// <summary>
            /// A list of all stars
            /// </summary>
            public static List<GeodexStar> Stars;
            ...
            /// </summary>
            public static GeodexStar Current;
            ...
            public static void SunBodyFlux(ModularFlightIntegrator flightIntegrator)
            {
                ...
                foreach (GeodexStar star in Stars.Where(s => s.sun != FlightIntegrator.sunBody))
                {
                    // Set Physics
            ...
            /// </summary>
            public static Double Flux(ModularFlightIntegrator fi, GeodexStar star)
            {
                // Nullchecks
            ...
            /// </summary>
            public static GeodexStar GetNearest(CelestialBody body)
            {
